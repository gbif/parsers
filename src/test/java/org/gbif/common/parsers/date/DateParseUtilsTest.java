...
public class DateParseUtilsTest {
  ...
  public void testNormalizeStringStringString() {
    ...
    // when we see an erroneous date, try and infer the year and month
    assertEquals(new YearMonthDay("1929", "06", null), DateParseUtils.normalize("1929-06-31", null, null));
