...
public class ThreeTenNumericalDateParserTest {
  ...
  public void testParseUndefinedLocalDateTime(){
    ThreeTenNumericalDateParser parser = new ThreeTenNumericalDateParser();
    assertEquals(ParseResult.STATUS.ERROR, parser.parse("120578").getStatus());
  }

  @Test
  public void testBadDates(){
    ThreeTenNumericalDateParser parser = new ThreeTenNumericalDateParser();
    assertEquals(ParseResult.STATUS.ERROR, parser.parse("fsfgr/12/78").getStatus());
    assertEquals(ParseResult.STATUS.ERROR, parser.parse("fsfgr").getStatus());
    assertEquals(ParseResult.STATUS.ERROR, parser.parse("//").getStatus());
    assertEquals(ParseResult.STATUS.ERROR, parser.parse("0-0-0").getStatus());
    assertEquals(ParseResult.STATUS.ERROR, parser.parse("%$-s2").getStatus());
    assertEquals(ParseResult.STATUS.ERROR, parser.parse("as-fds-sdf").getStatus());
    assertEquals(ParseResult.STATUS.ERROR, parser.parse("88/88/88").getStatus());
    assertEquals(ParseResult.STATUS.ERROR, parser.parse(" ").getStatus());
    assertEquals(ParseResult.STATUS.ERROR, parser.parse("").getStatus());
    assertEquals(ParseResult.STATUS.ERROR, parser.parse(null).getStatus());
  }
