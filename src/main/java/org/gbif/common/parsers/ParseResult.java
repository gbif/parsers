...
public class ParseResult<T> {
   ...
   */
  public static <T1> ParseResult<T1> fail(T1 payload) {
    return new ParseResult<T1>(STATUS.FAIL, null, payload, null);
  }
  ...
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append("status", getStatus())
      .append("confidence", getConfidence()).append("payload", getPayload()).append("error", getError()).toString();
  }
}
